...
<head>
  ...
  <title>ADMINISTRATION O | @yield('title')</title>
  <!-- Fonts -->
        ...
        <div class="header-body text-center mb-7">
          <div class="row justify-content-center">
            <div class="col-lg-5 col-md-6">
              ...
              <p class="text-lead text-light">Masukkan akun anda atau daftarkan data anda untuk memulai sesi</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="row align-items-center justify-content-xl-between">
          <div class="col-xl-6">
            <div class="copyright text-center text-xl-left text-muted">
              &copy; {{date('Y')}} <a href="https://chairulanam.ga" class="font-weight-bold ml-1" target="_blank">Chairul Anam</a>
            </div>
          </div>
          <div class="col-xl-6">
            <ul class="nav nav-footer justify-content-center justify-content-xl-end">
              <li class="nav-item">
                <a href="https://www.creative-tim.com" class="nav-link" target="_blank">Timcode</a>
              </li>
              <li class="nav-item">
