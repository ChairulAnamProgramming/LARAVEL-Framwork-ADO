                ...
                <div class="card-header border-0">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-4 mt-2">
                            <a href="{{url('/roster/print_bagian').'/'.$id_roster}}" class="btn btn-info btn-icon ">
                                <span class="btn-inner--icon">
              ...
              <tbody>
                  @foreach ($roster as $item)
                      <tr>
                        ...
                        <td>
                            <a class="btn btn-sm btn-info" href=" {{url("/roster/$item->id/jadwal")}}">Liat Jadwal</a>
                        </td>
                        <td>{{$item->name}}</td>
                        <td>{{$item->nik}}</td>
